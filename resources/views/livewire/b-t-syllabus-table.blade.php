<div class=" text-left">
    ...
    <table class="border-collapse py-12 w-[95%] bg-white border m-auto justify-center">
        ...
        <tbody class="divide-y divide-[#e5e7eb]">
            ...
            <tr class="p-[100px]">
                <td class="font-semibold px-4">{{ $syllabus->course_title }}</td>
                ...
                <td class="px-4">
                    <div class="py-4">
                        <form action="{{ route('bayanihanteacher.commentSyllabus', $syllabus->syll_id) }}" method="GET"> @csrf
                            <button type="submit" class="bg-blue px-4 text-white shadow-lg rounded">View</button>
                        </form>
                    </div>
                </td>
            </tr>
            ...
            @else
            <tr>
                <td colspan="9" class="text-center py-4">No syllabi found.</td>
            </tr>
            @endif
        </tbody>
    </table>
