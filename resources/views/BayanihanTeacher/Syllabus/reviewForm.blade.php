...
<body class="">
    <div class="flex justify-center">
        <div id="" class="mt-20 flex flex-col border  justify-center border-gray3 top-0  bg-white bg-opacity-100   rounded-lg font-sans">
            <div class=" justify-center items-center mx-10">
                ...
                <div class="grid grid-cols-2 grid-rows-2 mb-5">
                    <div>
                        Course Code: {{$reviewForm->srf_course_code}}
                    ...
                    <table id="review_form_table">
                        ...
                        <tbody>
                            ...
                            <tr class="">
                                ...
                                <td class="checkbox-cell">@if($srf1['srf_yes_no'] === 'yes') / @endif </td>
                                <td class="">@if($srf1['srf_yes_no'] === 'no') / @endif </td>
                                <td class="">{{$srf1->srf_remarks}}</td>
                            </tr>
                            <tr class="">
                                <td class="ones">• Name of the College/Campus is indicated below the University name/brand.</td>
                                <td class="checkbox-cell">@if($srf2['srf_yes_no'] === 'yes') / @endif </td>
                                <td class="">@if($srf2['srf_yes_no'] === 'no') / @endif </td>
                            ...
                            <tr class="">
                                ...
                                <td class="checkbox-cell">@if($srf3['srf_yes_no'] === 'yes') / @endif</td>
                                <td class="">@if($srf3['srf_yes_no'] === 'no') / @endif</td>
                                <td class="">{{$srf3->srf_remarks}}</td>
                            </tr>
                            <!-- 4  -->
                            <tr class="">
                                <td class="ones">• Pre-requisites and co-requisites are indicated.</td>
                                <td class="checkbox-cell">@if($srf4['srf_yes_no'] === 'yes') / @endif</td>
                                <td class="">@if($srf4['srf_yes_no'] === 'no') / @endif</td>
                            ...
                            <tr class="">
                                ...
                                <td class="checkbox-cell">@if($srf5['srf_yes_no'] === 'yes') / @endif</td>
                                <td class="">@if($srf5['srf_yes_no'] === 'no') / @endif</td>
                            ...
                            <tr class="">
                                ...
                                <td class="checkbox-cell">@if($srf6['srf_yes_no'] === 'yes') / @endif</td>
                                <td class="">@if($srf6['srf_yes_no'] === 'no') / @endif</td>
                            ...
                            <tr class="">
                                ...
                                <td class="checkbox-cell">@if($srf7['srf_yes_no'] === 'yes') / @endif</td>
                                <td class="">@if($srf7['srf_yes_no'] === 'no') / @endif</td>
                                <td class="">{{$srf7->srf_remarks}}</td>
                            </tr>
                            <!-- 1.7  -->
                            <tr class="">
                                <td class="ones">• The University’s Vision and Mission are indicated in the syllabus.</td>
                                <td class="checkbox-cell">@if($srf8['srf_yes_no'] === 'yes') / @endif</td>
                                <td class="">@if($srf8['srf_yes_no'] === 'no') / @endif</td>
                            ...
                            <tr class="">
                                ...
                                <td class="checkbox-cell">@if($srf9['srf_yes_no'] === 'yes') / @endif</td>
                                <td class="">@if($srf9['srf_yes_no'] === 'no') / @endif</td>
                            ...
                            <tr class="">
                                ...
                                <td class="checkbox-cell">@if($srf10['srf_yes_no'] === 'yes') / @endif</td>
                                <td class="">@if($srf10['srf_yes_no'] === 'no') / @endif</td>
                            ...
                            <tr class="">
                                ...
                                <td class="checkbox-cell">@if($srf11['srf_yes_no'] === 'yes') / @endif</td>
                                <td class="">@if($srf11['srf_yes_no'] === 'no') / @endif</td>
                            ...
                            <tr class="">
                                ...
                                <td class="checkbox-cell">@if($srf12['srf_yes_no'] === 'yes') / @endif</td>
                                <td class="">@if($srf12['srf_yes_no'] === 'no') / @endif</td>
                            ...
                            <tr class="">
                                ...
                                <td class="checkbox-cell">@if($srf13['srf_yes_no'] === 'yes') / @endif</td>
                                <td class="">@if($srf13['srf_yes_no'] === 'no') / @endif</td>
                                <td class="">{{$srf13->srf_remarks}}</td>
                            </tr>
                            <!-- 7  -->
                            <tr class="">
                                <td class="">7. Topics are assigned to intended learning outcomes (ILO).</td>
                                <td class="checkbox-cell">@if($srf14['srf_yes_no'] === 'yes') / @endif</td>
                                <td class="">@if($srf14['srf_yes_no'] === 'no') / @endif</td>
                                <td class="">{{$srf14->srf_remarks}}</td>
                            </tr>
                            <!-- 8  -->
                            <tr class="">
                                <td class="">8. Suggested readings are provided.</td>
                                <td class="checkbox-cell">@if($srf15['srf_yes_no'] === 'yes') / @endif</td>
                                <td class="">@if($srf15['srf_yes_no'] === 'no') / @endif</td>
                                <td class="">{{$srf15->srf_remarks}}</td>
                            </tr>
                            <!-- 9  -->
                            <tr class="">
                                <td class="">9. The Teaching-Learning Activities (TLAs) are indicated in the outline.</td>
                                <td class="checkbox-cell">@if($srf16['srf_yes_no'] === 'yes') / @endif</td>
                                <td class="">@if($srf16['srf_yes_no'] === 'no') / @endif</td>
                            ...
                            <tr class="">
                                ...
                                <td class="checkbox-cell">@if($srf17['srf_yes_no'] === 'yes') / @endif</td>
                                <td class="">@if($srf17['srf_yes_no'] === 'no') / @endif</td>
                                <td class="">{{$srf17->srf_remarks}}</td>
                            </tr>
                            <!-- 11  -->
                            <tr class="">
                                <td class="">11. Rubrics are attached for all outputs/requirements.</td>
                                <td class="checkbox-cell">@if($srf18['srf_yes_no'] === 'yes') / @endif</td>
                                <td class="">@if($srf18['srf_yes_no'] === 'no') / @endif</td>
                                <td class="">{{$srf18->srf_remarks}}</td>
                            </tr>
                            <!-- 12  -->
                            <tr class="">
                                <td class="">12. The grading criteria are clearly stated in the syllabus.</td>
                                <td class="checkbox-cell">@if($srf19['srf_yes_no'] === 'yes') / @endif</td>
                                <td class="">@if($srf19['srf_yes_no'] === 'no') / @endif</td>
