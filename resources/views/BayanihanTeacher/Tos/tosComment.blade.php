...
<body>
    <div class="flex flex-col justify-center mb-20 w-screen mt-[2%]">
        <div class="mt-24 mx-auto shadow-lg pb-10 border border-white bg-white w-[80%]">
            ...
            <div class="mt-10 flex justify-center">
                ...
                <table class="mt-2 ml-4 border-2 border-solid w-8/12 font-serif text-sm bg-white">
                    ...
                    <tr>
                        <th>
                            <div class="text-right align-top -mr-2 -mt-1">
                                <livewire:tos-a-comment :tos_id="$tos->tos_id" :col_no='1' />
                            </div>
                            <div class="text-center mb-2 -mt-1">{{$tos->col_1_per}}%</div>
                        </th>
                        <th>
                            <div class="text-right align-top -mr-2 -mt-1">
                                <livewire:tos-a-comment :tos_id="$tos->tos_id" :col_no='2'/>
                            </div>
                            <div class="text-center mb-2 -mt-1">{{$tos->col_2_per}}%</div>
                        </th>
                        <th>
                            <div class="text-right align-top -mr-2 -mt-1">
                                <livewire:tos-a-comment :tos_id="$tos->tos_id" :col_no='3'/>
                            </div>
                        ...
                        <th>
                            <div class="text-right align-top -mr-2 -mt-1">
                                <livewire:tos-a-comment :tos_id="$tos->tos_id" :col_no='4'/>
                            </div>
                    ...
                    <tr>
                        <td class="">
                            <div class="text-right align-top -mr-2 -mt-1"><livewire:tos-ro-comment :tos_r_id="$tos_row->tos_r_id" :col_no='1' /></div>
                            <div class="text-left mb-2 -mt-1">{!! nl2br(e($tos_row->tos_r_topic)) !!} </div>
                        </td>
                        <td class="">
                            <div class="text-right align-top -mr-2 -mt-1"><livewire:tos-ro-comment :tos_r_id="$tos_row->tos_r_id" :col_no='2' /></div>
                            <div class="text-center mb-2 -mt-1">{{ $tos_row->tos_r_no_hours }} </div>
                        </td>
                        <td class="">
                            <div class="text-right align-top -mr-2 -mt-1"><livewire:tos-ro-comment :tos_r_id="$tos_row->tos_r_id" :col_no='3' /></div>
                            <div class="text-center mb-2 -mt-1 mx-3">{{ $tos_row->tos_r_percent }} </div>
                        </td>
                        <td class="">
                            <div class="text-right align-top -mr-2 -mt-1"><livewire:tos-ro-comment :tos_r_id="$tos_row->tos_r_id" :col_no='4' /></div>
                            <div class="text-center mb-2 -mt-1">{{ $tos_row->tos_r_no_items }} </div>
                        </td>
                        <td class="">
                            <div class="text-right align-top -mr-2 -mt-1"><livewire:tos-ro-comment :tos_r_id="$tos_row->tos_r_id" :col_no='5' /></div>
                            <div class="text-center mb-2 -mt-1">{{ intval($tos_row->tos_r_col_1) }} </div>
                        </td>
                        <td class="">
                            <div class="text-right align-top -mr-2 -mt-1"><livewire:tos-ro-comment :tos_r_id="$tos_row->tos_r_id" :col_no='6' /></div>
                            <div class="text-center mb-2 -mt-1">{{ intval($tos_row->tos_r_col_2) }}</div>
                        </td>
                        <td class="">
                            <div class="text-right align-top -mr-2 -mt-1"><livewire:tos-ro-comment :tos_r_id="$tos_row->tos_r_id" :col_no='7' /></div>
                            <div class="text-center mb-2 -mt-1">{{ intval($tos_row->tos_r_col_3) }} </div>
                        </td>
                        <td class="">
                            <div class="text-right align-top -mr-2 -mt-1"><livewire:tos-ro-comment :tos_r_id="$tos_row->tos_r_id" :col_no='8' /></div>
                    ...
                    <tr>
                        ...
                        <td class="text-center font-bold">
                            <div class="text-right align-top -mr-2 -mt-1">
                                <livewire:tos-a-comment :tos_id="$tos->tos_id" :col_no='5' />
                            </div>
                            {{$total_tos_r_no_hours}}
                        </td>
                        <td class="text-center font-bold p-2">
                            <div class="text-right align-bottom -mr-2 -mt-1">
                            </div>
                        {{$total_tos_r_percent}}
                        </td>
                        <td class="text-center font-bold p-2">
                            <div class="text-right align-top -mr-2 -mt-1">
                                <livewire:tos-a-comment :tos_id="$tos->tos_id" :col_no='6' />
                            </div>
                            {{$tos->tos_no_items}}
                        </td>
                        <td class="text-center font-bold p-2">
                            <div class="text-right align-top -mr-2 -mt-1">
                                <livewire:tos-a-comment :tos_id="$tos->tos_id" :col_no='7' />
                            </div>
                            {{$total_tos_r_col_1}}
                        </td>
                        <td class="text-center font-bold p-2">
                            <div class="text-right align-top -mr-2 -mt-1">
                                <livewire:tos-a-comment :tos_id="$tos->tos_id" :col_no='8' />
                            </div>
                            {{$total_tos_r_col_2}}
                        </td>
                        <td class="text-center font-bold p-2">
                            <div class="text-right align-top -mr-2 -mt-1">
                                <livewire:tos-a-comment :tos_id="$tos->tos_id" :col_no='9' />
                            </div>
                            {{$total_tos_r_col_3}}
                        </td>
                        <td class="text-center font-bold p-2">
                            <div class="text-right align-top -mr-2 -mt-1">
                                <livewire:tos-a-comment :tos_id="$tos->tos_id" :col_no='10' />
                            </div>
                            {{$total_tos_r_col_4}}
                        </td>
                    </tr>
