    ...
    <div class="">
        <div class="relative">
            <div class="fixed top-0 z-50" id="nav">
                <nav class="w-screen flex px-6 md:shadow-lg items-center relative bg-blue py-">
                 ...
                 -->
                    ...
                    <ul class="md:px-2 ml-auto md:flex md:space-x-2 absolute md:relative top-full left-0 right-0">
                        <li>
                            <a href="{{ route('chairperson.home') }}" class="rounded  borderflex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird {{request()->route()->getName() == 'chairperson.home' ? 'bg-seThird border-b- border-seThird text-white' : ''}}" class="border-b-4 rounded border-yellow borderflex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird">
                                <span>Home</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('chairperson.programOutcome') }}" class="rounded  borderflex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird {{request()->route()->getName() == 'chairperson.programOutcome' ? 'bg-seThird border-b- border-seThird text-white' : ''}}" class="flex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird">
                                <span>Outcomes</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('chairperson.poe') }}" class="rounded  borderflex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird {{request()->route()->getName() == 'chairperson.poe' ? 'bg-seThird border-b- border-seThird text-white' : ''}}" class="flex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird">
                                <span>Educational Objectives</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('chairperson.curr') }}" class="rounded  borderflex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird {{request()->route()->getName() == 'chairperson.curr' ? 'bg-seThird border-b- border-seThird text-white' : ''}}" class="flex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird">
                                <span>Curricula</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('chairperson.course') }}" class="rounded  borderflex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird {{request()->route()->getName() == 'chairperson.course' ? 'bg-seThird border-b- border-seThird text-white' : ''}}" class="flex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird">
                                <span>Courses</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('chairperson.bayanihan') }}" class="rounded  borderflex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird {{request()->route()->getName() == 'chairperson.bayanihan' ? 'bg-seThird border-b- border-seThird text-white' : ''}}" class="flex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird">
                                <span>Bayanihan Teams</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('chairperson.syllabus') }}" class="rounded  borderflex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird {{request()->route()->getName() == 'chairperson.syllabus' ? 'bg-seThird border-b- border-seThird text-white' : ''}}" class="flex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird">
                                <span>Syllabus</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('chairperson.tos') }}" class="rounded  borderflex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird {{request()->route()->getName() == 'chairperson.tos' ? 'bg-seThird border-b- border-seThird text-white' : ''}}" class="flex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird">
                                <span>TOS</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('chairperson.reports') }}" class="rounded  borderflex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird {{request()->route()->getName() == 'chairperson.reports' ? 'bg-seThird border-b- border-seThird text-white' : ''}}" class="flex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird">
                                <span>Reports</span>
                            </a>
                        </li>
                ...
                -->
                        ...
                        <div class="relative parent">
                            ...
                            <a class="cursor-pointer mt-3 border-2 w-8 h-8 flex justify-center md:inline-flex text-white hover:text-beige items-center hover:bg-seThird bg-yellow rounded-full bg-white justify-center" onclick="toggleDropdown()">
