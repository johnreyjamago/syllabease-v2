...
<body class="">
    <div class="">
        <div class="fixed top-0 w-screen">
            <nav class="w-screen flex px-6 md:shadow-lg items-center relative bg-blue">
                ...
                <ul class="md:px-2 ml-auto md:flex md:space-x-2 absolute md:relative top-full left-0 right-0">
                    <li>
                        <a href="{{ route('dean.home') }}" class="rounded  borderflex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird {{request()->route()->getName() == 'dean.home' ? 'bg-seThird border-b- border-seThird text-white' : ''}}" class="flex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird">
                            <span>Home</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('dean.departments') }}" class="rounded  borderflex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird {{request()->route()->getName() == 'dean.departments' ? 'bg-seThird border-b- border-seThird text-white' : ''}}" class="flex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird">
                            <span>Departments</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('dean.chairs') }}" class="rounded  borderflex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird {{request()->route()->getName() == 'dean.chairs' ? 'bg-seThird border-b- border-seThird text-white' : ''}}" class="flex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird">
                            <span>Chairs</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('dean.syllList') }}" class="rounded  borderflex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird {{request()->route()->getName() == 'dean.syllList' ? 'bg-seThird border-b- border-seThird text-white' : ''}}" class="flex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird">
                            <span>Syllabus</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('dean.deadline') }}" class="rounded  borderflex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird {{request()->route()->getName() == 'dean.deadline' ? 'bg-seThird border-b- border-seThird text-white' : ''}}" class="flex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird">
                            <span>Deadline</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('dean.reports') }}" class="rounded  borderflex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird {{request()->route()->getName() == 'dean.reports' ? 'bg-seThird border-b- border-seThird text-white' : ''}}" class="flex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird">
                            <span>Reports</span>
                        </a>
                    </li>
                    <!-- Notification -->
                    <div class="md:px-2 ml-auto md:flex md:space-x-3 absolute md:relative mt-2 top-full left-0 right-0">
                        <div class="relative parent">
                            ...
                            <a class="cursor-pointer  w-8 h-8 flex justify-center md:inline-flex hover:text-beige items-center hover:bg-seThird rounded-full" onclick="toggleNotifDropdown()">
                                <div class="">
        ...
        <div class="md:px-2 ml-auto md:flex md:space-x-3 absolute md:relative mt-2 top-full left-0 right-0">
            <div class="relative parent">
                <!-- User Avatar and Initials -->
                <a class="cursor-pointer border-2 w-8 h-8 flex justify-center md:inline-flex text-white hover:text-beige items-center hover:bg-seThird rounded-full bg-white" onclick="toggleDropdown()">
