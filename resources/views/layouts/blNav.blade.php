                ...
                <nav class="w-screen flex px-6 md:shadow-lg items-center relative bg-blue">
                 ...
                 -->
                    ...
                    <ul class="md:px-2 ml-auto md:flex md:space-x-2 absolute md:relative top-full left-0 right-0">
                        <li>
                            <a href="{{ route('bayanihanleader.home') }}" class="rounded  borderflex text-white hover:text-black md:inline-flex p-3 items-center hover:bg-seThird {{request()->route()->getName() == 'bayanihanleader.home' ? 'bg-seThird border-b- border-seThird text-white' : ''}}" class="border-b-4 rounded border-yellow borderflex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird">
                                <span>Home</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('bayanihanleader.syllabus') }}" class="rounded  borderflex text-white hover:text-black md:inline-flex p-3 items-center hover:bg-seThird {{request()->route()->getName() == 'bayanihanleader.syllabus' ? 'bg-seThird border-b- border-seThird text-white' : ''}}" class="flex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird">
                                <span>Syllabus</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('bayanihanleader.tos') }}" class="rounded  borderflex text-white hover:text-black md:inline-flex p-3 items-center hover:bg-seThird {{request()->route()->getName() == 'bayanihanleader.tos' ? 'bg-seThird border-b- border-seThird text-white' : ''}}" class="flex text-white hover:text-black md:inline-flex p-4 items-center hover:bg-seThird">
                                <span>TOS</span>
                            </a>
                        </li>
                        <!-- Notification -->
