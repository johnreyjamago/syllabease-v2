            ...
            <div class="m-8">
                <form action="{{ route('bayanihanleader.updateTos', ['syll_id' => $tos->syll_id, 'tos_id' => $tos_id]) }}" method="POST">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="">
                            <p class="">Knowledge</p>
                            <input type="number" value="{{$tos->col_1_per}}" name="col_1_per" id="col_1_per" class="percentage-input border w-max border-[#a8a29e] rounded w-[400px] p-2" required>
                        </div>

                        <div class="">
                            <p>Comprehension</p>
                            <input type="number" value="{{$tos->col_2_per}}" name="col_2_per" id="col_2_per" class="percentage-input border w-max border-[#a8a29e] rounded w-[400px] p-2" required>
                        </div>

                        <div class="">
                            <p>Application/ Analysis</p>
                            <input type="number" value="{{$tos->col_3_per}}" name="col_3_per" id="col_3_per" class="percentage-input border w-max border-[#a8a29e] rounded w-[400px] p-2" required>
                        </div>

                        <div class="">
                            <p>Synthesis/ Evaluation</p>
                            <input type="number" value="{{$tos->col_4_per}}" name="col_4_per" id="col_4_per" class="percentage-input border w-max border-[#a8a29e] rounded w-[400px] p-2" required>
                        </div>
                    </div>
