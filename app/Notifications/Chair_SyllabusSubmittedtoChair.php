...
class Chair_SyllabusSubmittedtoChair extends Notification
{
    use Queueable;
    public $course_code;
    ...
    {
        return [
            'message' => 'A syllabus has been submitted.',
            'course_code' => $this->course_code,
            'bg_school_year' => $this->bg_school_year,
            'syll_id' => $this->syll_id,
        ];
    }
    public function toDatabase($notifiable)
    {
        return [
            ...
            'type' => 'syllabus',
            'for' => 'C',
            'action_url' => route('chairperson.viewSyllabus', [$this->syll_id]),
        ];
    }
}
